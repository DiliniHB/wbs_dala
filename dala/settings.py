...
TABLE_PROPERTY_MAPPER = {
    ...
    'Table_10':
		...
		'Table_3':
    {
        'BucMarStructure': ['particulars', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'id'],
        'BucMarSupplies': ['particulars', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'id'],
        'BucMarMequipment': ['particulars', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'id'],
        'BucMarOassets': ['particulars', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'id'],
        'BucMarcStructures': ['particulars', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'id'],
        'BucMarcMequipment': ['particulars', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'id'],
        'BucMarcOassets': ['particulars', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'id'],
        'BucMarcCrpm': ['particulars', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'id'],
    },
'Table_5':
    {
        'DmhDfNum': ['num_des_facilities', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhDfPaf': ['num_patients_affected', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhNdatFacStructure': ['asset', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'total', 'id'],
        'DmhNdatFacSupplies': ['asset', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'total', 'id'],
        'DmhNdatFacMequipment': ['asset', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'total', 'id'],
        'DmhNdatFacOassets': ['asset', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhPdfaNum': ['num_des_facilities', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhPdfaPaf':['num_patients_affected', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhPdfaStructure': ['asset', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhPdfaMequipment': ['asset', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'total', 'id'],
        'DmhPdfaOassets': ['asset', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhLosFi': ['type_of_losses', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhLosCud': ['type_of_losses', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhLosHoc': ['type_of_losses', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
        'DmhLosOue': ['type_of_losses', 'teaching_hospital', 'provincial_general_hospital', 'district_general_hospital', 'office', 'other', 'total', 'id'],
    },'Table_7':
    {
